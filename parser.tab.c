...
static const char *const yytname[] =
{
  ...
  "DIV", "LPAREN", "RPAREN", "NUMBER", "$accept", "program", "expression",
...
#line 1083 "parser.tab.c"
  ...
  case 4: /* expression: expression ADD term  */
#line 27 "parser.y"
                                 { (yyval.integer) = (yyvsp[-2].integer) + (yyvsp[0].integer); }
#line 1089 "parser.tab.c"
    break;

  case 5: /* expression: expression SUB term  */
#line 28 "parser.y"
                                 { (yyval.integer) = (yyvsp[-2].integer) - (yyvsp[0].integer); }
...
#line 1119 "parser.tab.c"
  ...
  case 10: /* factor: LPAREN expression RPAREN  */
#line 37 "parser.y"
